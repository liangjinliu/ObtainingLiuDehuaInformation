pipeline {
	    agent any
	        ...
	        UIPATH_ORCH_LOGICAL_NAME = "xiaobei"
	        UIPATH_ORCH_TENANT_NAME = "Test"
	    ...
	    stages {
	        ...
	        stage('Perform Tests') {
	            steps {
					...
					UiPathTest (
					  testTarget: [$class: 'TestSetEntry', testSet: "Obtaining-Liu-Dehua-Information"],
					  orchestratorAddress: "${UIPATH_ORCH_URL}",
					  orchestratorTenant: "${UIPATH_ORCH_TENANT_NAME}",
					  folderName: "${UIPATH_ORCH_FOLDER_NAME}",
					  timeout: 10000,
